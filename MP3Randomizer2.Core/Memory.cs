...
namespace MP3Randomizer2.Core
{
    public class Memory
    {
        // This is a default class I made a while ago with a lot of (unnecessary) memory methods. I don't even know what they all do, but they're here so you can use them if you want.
        // - Earleys
       ...
       /* public static string GiveMemoryResult(Process process, long address, int _byte)
        ...
        public static int GetMemoryResult(Process process, int address, int _byte)
        {
